...
class Camera(
    ...
    internal val streamingProfile: CamcorderProfile
    ...
    fun createCaptureSessionNewSurface(templateType: Int, onSuccessCallback: Runnable, surfaceList: MutableList<Surface>) {
        // Close the old session first.
        closeCaptureSession()
    ...
    init {
        ...
        currentOrientation = (activity.resources.configuration.orientation / 90.0).roundToInt().toInt() * 90
