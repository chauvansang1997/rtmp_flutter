...
class RtmpCameraConnector(val context: Context, val useOpenGL: Boolean, val isPortrait: Boolean, val connectChecker: ConnectCheckerRtmp) :
    ...
    private var microphoneManager: MicrophoneManager = MicrophoneManager(this)
    private var audioEncoder: AudioEncoder = AudioEncoder(this)
    private var srsFlvMuxer: SrsFlvMuxer = SrsFlvMuxer(this)
